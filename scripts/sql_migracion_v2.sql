...
--Cargar roles
insert into NEW_SOLUTION.Roles(rol_id,rol_nombre,rol_estado) values(1,'Administrador','s')
insert into NEW_SOLUTION.Roles(rol_id,rol_nombre,rol_estado) values(2,'Cliente','s')

--Cargar la relaciones de roles con funcionalidades.
insert into NEW_SOLUTION.Rol_funcionalidades(rol_id,func_id) values(1,1)
insert into NEW_SOLUTION.Rol_funcionalidades(rol_id,func_id) values(1,2)
insert into NEW_SOLUTION.Rol_funcionalidades(rol_id,func_id) values(2,1)
insert into NEW_SOLUTION.Rol_funcionalidades(rol_id,func_id) values(2,2)
