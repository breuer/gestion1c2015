...
namespace PagoElectronico.Tarjetas
{
    public partial class FormTarjetas : Form
    {
        ...
        {
            if (grilla_tarjetas.Rows.Count > 0)
            {
                ...
                {
                    MessageBox.Show("No hay ninguna tarjeta seleccionada, hace click en la 1ra columna.");
                }
            }
            else
            {
                MessageBox.Show("No hay ninguna tarjeta vinculada.");
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No hay ninguna tarjeta vinculada, para poder desvincularla.");
            }
        }
