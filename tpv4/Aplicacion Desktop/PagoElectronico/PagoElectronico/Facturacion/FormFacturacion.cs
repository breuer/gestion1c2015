...
namespace PagoElectronico.Facturacion
{
    public partial class FormFacturacion : Form
    {
        ...
        private void cargar_grilla_columnas()
        {
            ...
            //Agrego las columnas.
            grilla_facturas.Columns.AddRange(new DataGridViewColumn[] { numero, fecha,creador});
        ...
        private void cargar_datos_grilla(DataTable data)
        {
            ...
            foreach (DataRow row in data.Rows)
            {
                ...
                grilla_facturas.Rows.Add(row["fact_id"].ToString(), row["fact_fecha"].ToString(), creador);
            }
        }
        ...
        private void grilla_facturas_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
