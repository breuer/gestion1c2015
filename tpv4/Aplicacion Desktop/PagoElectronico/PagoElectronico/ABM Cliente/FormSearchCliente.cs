...
namespace PagoElectronico.ABM_Cliente
{
    public partial class FormSearchCliente : Form
    {
        ...
        private void btSearch_Click(object sender, EventArgs e)
        {
            ...
            cliente.TipoDeIdentificacionCod = cbTipoIdentificacion.SelectedIndex == -1 ? null : (int?) int.Parse(cbTipoIdentificacion.SelectedValue.ToString());
            ...
            { 
                MessageBox.Show("No se han encontrado resultados para esta busqueda");
            }
        }
        ...
        private void btSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No hay nigun cliente seleccionado.");            
            }
        }

        private void FormSearchCliente_Load(object sender, EventArgs e)
        {
