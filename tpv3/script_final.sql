...
insert into NEW_SOLUTION.Funcionalidades(func_id,func_nombre) values(15,'CuentasCliente')
...
where func_id in(3,9,1,2,4,10,12,13,14)
go

--Para clientes
insert into NEW_SOLUTION.Rol_funcionalidades(rol_id,func_id)
select 2,func_id from NEW_SOLUTION.Funcionalidades
where func_id in(1,4,5,6,7,8,10,11,15)
go
...
select distinct
	  (convert(varchar,a.Cli_Pais_codigo)+convert(varchar,a.Cli_Tipo_Doc_Cod)+convert(varchar,a.Cli_Nro_Doc)),      a.[Cli_Nombre],
      a.[Cli_Apellido],
      a.[Cli_Tipo_Doc_Cod],      
      a.[Cli_Nro_Doc],
	  b.pais_id,
...
insert into NEW_SOLUTION.Cuentas_categ(ctacateg_id,ctacateg_descrip,ctacateg_costo,ctacateg_duracion_dias,ctacateg_estado_inicial) values(0,'Oro',0,0,2)
insert into NEW_SOLUTION.Cuentas_categ(ctacateg_id,ctacateg_descrip,ctacateg_costo,ctacateg_duracion_dias,ctacateg_estado_inicial) values(1,'Plata',0,0,2)
insert into NEW_SOLUTION.Cuentas_categ(ctacateg_id,ctacateg_descrip,ctacateg_costo,ctacateg_duracion_dias,ctacateg_estado_inicial) values(2,'Bronce',0,0,2)
insert into NEW_SOLUTION.Cuentas_categ(ctacateg_id,ctacateg_descrip,ctacateg_costo,ctacateg_duracion_dias,ctacateg_estado_inicial) values(3,'Gratuitas',0,0,1)
go
	...
	if exists (	select * from NEW_SOLUTION.Clientes c where c.cli_mail = @mail)
		...
		begin
			insert into NEW_SOLUTION.Clientes(
				...
				cli_nacionalidad)
			values (
				(convert(varchar,@nacionalidad)+convert(varchar,@tipo_documento)+convert(varchar,@documento)),
				@apellido,
				@nombre,
				@mail,
				@tipo_documento,
...
begin
	declare @estado int
	select 
		@estado=cc.ctacateg_estado_inicial 
